...
async function startRegistration(creationOptionsJSON) {
  ...
  const publicKey = {
    ...
    excludeCredentials: (_a = creationOptionsJSON.excludeCredentials) == null ? void 0 : _a.map(toPublicKeyCredentialDescriptor)
  };
...
async function startAuthentication(requestOptionsJSON, useBrowserAutofill = false) {
  ...
  if (((_a = requestOptionsJSON.allowCredentials) == null ? void 0 : _a.length) !== 0) {
    allowCredentials = (_b = requestOptionsJSON.allowCredentials) == null ? void 0 : _b.map(toPublicKeyCredentialDescriptor);
  }
  const publicKey = {
    ...requestOptionsJSON,
